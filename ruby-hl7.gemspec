...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/test_basic_parsing.rb", "test/test_child_segment.rb", "test/test_default_segment.rb", "test/test_dynamic_segment_def.rb", "test/test_msa_segment.rb", "test/test_obr_segment.rb", "test/test_obx_segment.rb", "test/test_pid_segment.rb", "test/test_speed_parsing.rb"]
